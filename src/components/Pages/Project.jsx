    ...
    <>
      <div className="pt-14 text-white bg-[#]  bg-gray-900 pb-32 " id="projects">
        ...
        <div className="flex flex-wrap justify-center items-center pt-6 mx-14  gap-5">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mx-2 w-[400px]">
            <img src={Project3} alt="Card Image" className="  object-cover  rounded-xl" />
            <h2 className="text-xl font-semibold mt-4 text-gray-900">Weather </h2>
            <p className="text-gray-600 mt-2">The website will display weather information data for the city. </p>
            <a href="https://buildcode-fp4-kelompok7.netlify.app/" className="text-white bg-gray-900 py-4 px-5  font-medium mt-4 inline-block">
              Read More
            </a>
          </div>
        </div>
